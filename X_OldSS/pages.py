...
page_sequence = [#Welcome, #CA 
                 #Participantcode, #NA
                 #GenderAge, #DA
                 #NetworkNamedPersons, #NA
                 #Sonntagsfrage, #PA
                 #ScaloParty, #PA
                 #ScaloPerson, #PA
                 #LeftrightSelfassessment, #NA
                 #LeftRight, #PA
                 #PoliticalQuestions, #PA
                 #NetworkFriendsPolitics, #NA
                 #NetworkFriends, #NA
                 #Tutorials, #DA
                 #RandomNumber, #CA 
                 #FirstEndPage, #PA (put in last app)
                 #End] #PA (put in last app)
